  ...
  return (
    <Card className="w-full max-w-md border-0 shadow-2xl shadow-navy-900/20 dark:shadow-black/40">
      <CardHeader className="space-y-3 text-center pb-2">
        ...
        <CardDescription>Sign in to your Future Sight account</CardDescription>
      </CardHeader>
      ...
      <CardFooter className="justify-center">
        <p className="text-sm text-muted-foreground">
          ...
          <Link href="/register" className="font-medium text-navy-500 hover:text-navy-400 transition-colors">
            Create one
          </Link>
        </p>
      </CardFooter>
