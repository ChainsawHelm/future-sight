  ...
  return (
    <div className="w-full max-w-[380px] mx-auto animate-fade-in font-mono">
      ...
      <div className="border border-primary/20 overflow-hidden bg-card shadow-terminal">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="text-[10px] text-muted-foreground">
            <span className="text-primary/50">&gt;</span> Authenticate to access terminal...
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            >
              {isLoading
                ? <><Spinner size="sm" className="text-primary-foreground" /> AUTHENTICATING...</>
                : '> LOGIN'
              }
            </button>
          </form>
      ...
      <p className="text-[10px] text-muted-foreground/50 mt-4 text-center font-mono tracking-wide">
        No account?{' '}
        <Link href="/register" className="text-primary/60 hover:text-primary transition-colors">
          ./register
        </Link>
      </p>
